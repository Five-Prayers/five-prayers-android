...
public class PreferencesConstants {
    ...
    public static final String READING_SCHEDULE_FREQUENCY = "READING_SCHEDULE_FREQUENCY";
    ...
    // Invocations
    public static final String INVOCATIONS_NOTIFICATIONS_ENABLED = "INVOCATIONS_NOTIFICATIONS_ENABLED";
