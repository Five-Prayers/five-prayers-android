...
public class NotifierConstants {
    ...
    public static final String QURAN_READING_NOTIFICATION_CHANNEL_ID = "QURAN_READING_NOTIFICATION_CHANNEL_ID";
    public static final String QURAN_READING_NOTIFICATION_CHANNEL_NAME = "QURAN_READING_NOTIFICATION_CHANNEL_NAME";
    public static final String QURAN_READING_NOTIFICATION_CHANNEL_DESCRIPTION = "QURAN_READING_NOTIFICATION_CHANNEL_DESCRIPTION";
}
