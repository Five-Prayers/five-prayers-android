 ...
 */
public class MorningInvocationActivity extends InvocationActivity {

    @Override
    public Map<String, List<Invocation>> getInvocation() {
        QuranParser quranParser = QuranParser.getInstance();
        return quranParser.getMorningInvocations(getApplicationContext());
    }

    @Override
    public int getToolbarTitleResourceId() {
        return R.string.morning_invocations;
    }
}
