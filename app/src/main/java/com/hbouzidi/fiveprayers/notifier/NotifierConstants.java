...
public class NotifierConstants {
    ...
    public static final String INVOCATIONS_NOTIFICATION_CHANNEL_ID = "INVOCATIONS_NOTIFICATION_CHANNEL_ID";
    public static final String INVOCATIONS_NOTIFICATION_CHANNEL_NAME = "INVOCATIONS_NOTIFICATION_CHANNEL_NAME";
    public static final String INVOCATIONS_NOTIFICATION_CHANNEL_DESCRIPTION = "INVOCATIONS_NOTIFICATION_CHANNEL_DESCRIPTION";
}
